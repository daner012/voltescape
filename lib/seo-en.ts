...
export const seoCopyEn: Record<string, SeoCopyEn> = {
  ...
  "cheap-flights-to-athens": {
    title: "Cheap Flights from Tel Aviv to Athens",
    description:
  ...
  "cheap-flights-to-berlin": {
    title: "Cheap Flights from Tel Aviv to Berlin",
    description:
  ...
  "cheap-flights-to-rome": {
    title: "Cheap Flights from Tel Aviv to Rome",
    description:
  ...
  "weekend-flights-from-tel-aviv": {
    title: "Weekend Flights from Tel Aviv",
    description:
  ...
  "europe-flight-deals": {
    title: "Europe Flight Deals from Tel Aviv",
    description:
  ...
  "luxury-travel-deals": {
    title: "Luxury Travel Deals from Tel Aviv",
    description:
  ...
  "cheap-flights-to-larnaca": {
    title: "Cheap Flights from Tel Aviv to Larnaca",
    description:
  ...
  "cheap-flights-to-greece": {
    title: "Cheap Flights from Tel Aviv to Greece",
    description:
  ...
  "cheap-flights-to-prague": {
    title: "Cheap Flights from Tel Aviv to Prague",
    description:
  ...
  "cheap-flights-to-budapest": {
    title: "Cheap Flights from Tel Aviv to Budapest",
    description:
  ...
  "cheap-flights-to-barcelona": {
    title: "Cheap Flights from Tel Aviv to Barcelona",
    description:
  ...
  "cheap-flights-to-istanbul": {
    title: "Cheap Flights from Tel Aviv to Istanbul",
    description:
  ...
  "summer-flights-from-tel-aviv": {
    title: "Summer Flights from Tel Aviv",
    description:
